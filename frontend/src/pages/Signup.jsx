...
const Signup = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-50 border-gray-200">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg border p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 mt-2 text-white font-medium py-2.5 rounded-lg transition-colors flex justify-center items-center h-11"
          >
            {loading ? (
